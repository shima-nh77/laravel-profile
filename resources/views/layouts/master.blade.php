...
@yield('content')
<!--footer area start-->
<footer class="footer_widgets mt-4">
                ...
                <div class="col-lg-3 col-md-7 col-sm-12">
                    <div class="widgets_container">
                        ...
                        <div class="footer_contact">
                            ...
                            <p>، چهار راه آبرسان، فلکه دانشگاه، برج تجاری بلور، طبقه 456، واحد 45</p>
                        </div>
...
<script src="/../assets/js/ostan.js"></script>
<!-- js style for profile page  -->
